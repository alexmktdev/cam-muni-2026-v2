// Iconos reutilizables para navegación del panel (solo presentación).
...
export function IconGridFour({ className }: { className?: string }) {
  return (
...
export function IconUsersTwo({ className }: { className?: string }) {
  return (
    <svg
      viewBox="0 0 24 24"
      className={className}
...
/** Documento duplicado (registros repetidos / varios clubes). */
...
export function IconFingerprint({ className }: { className?: string }) {
  return (
    <svg
      ...
      aria-hidden
    >
      <path d="M12 10a2 2 0 0 0-2 2c0 1.5.5 3 2 5" />
      <path d="M12 6a6 6 0 0 1 6 6c0 2-.5 4-2 6" />
